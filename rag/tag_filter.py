...
PRODUCT_ALIASES = {
    ...
    "ankamec-3.6ec": ["diet sau ankamec", "tru sau ankamec 3 6", "ec", "nong", "ankamec"],
    "asmilka-top-325sc": ["diet sau asmilka top", "tru sau asmilka top 325", "sc", "mat", "asmilka"],
    "atomin-15wp": ["diet sau atomin", "tru sau atomin 15wp", "atomin"],
    "benxana-240sc": ["diet sau benxana", "tru sau benxana 240", "sc", "mat", "benxana"],
    ...
    "dapharnec-3.6ec": ["diet sau dapharnec", "tru sau dapharnec 3 6", "ec", "nong", "dapharnec"],
    ...
    "forsan-60ec": ["diet sau forsan", "tru sau forsan 60", "ec", "nong", "forsan", "forsan60ec"],
    ...
    "gone-super-350ec": ["gone super", "gon super", "diet sau gone super", "tru sau gone super 350", "ec", "nong", "gon super", "gone super", "3 hoat chat", "ba hoat chat"],
    "haihamec": ["diet sau haihamec", "tru sau haihamec", "haihamec"],
    "haruko-5sc": ["diet sau haruko", "tru sau haruko 5", "sc", "mat", "haruko"],
    ...
    "koto-240sc": ["diet sau koto", "tru sau koto 240", "sc", "mat", "koto"],
    "koto-240sc-gold": ["diet sau koto gold", "tru sau koto 240", "sc", "gold", "koto gold", "koto"],
    "kyodo-25sc": ["diet sau kyodo", "tru sau kyodo 25", "sc", "mat", "kyodo"],
    ...
    "recxona-350SC": ["recxona 350", "sc", "mat", "recxona 350sc", "recxona"],
    ...
    "teen-super-350ec": ["teen super", "teensuper", "teen super 350", "ec", "nong"],
    ...
    "abinsec-1-8ec": ["abinsec 1 8", "ec", "nong", "abinsec 1.8ec", "abinsec 1.8", "abinsec 1.8ec ", "abinsec"],
    "abinsec-emaben-sau-1-8ec": ["abinsec emaben sau 1 8", "ec", "nong", "abinsec", "emaben"],
    "abinsec-oxatin-1-8ec": ["abinsec oxatin 1 8", "ec", "nong", "oxatin", "abinsec", "abinsec oxatin", "abinsec oxatin"],
    "abinsec-sieu-diet-nhen": ["abinsec diet nhen sieu toc", "sieu diet nhen", "abinsec nhen", "abinsec"],
    "aco-one-40ec": ["aco one 40", "ec", "nong", "aco one", "acoone"],
    "aco-one400ec": ["aco one 400ec", "aco one", "acoone"],
    "afenzole-325sc": ["afenzole 325", "sc", "mat", "afenzole", "afenzole 325sc", "afenzole"],
    "amesip-80wp": ["amesip 80wp", "amesip", "amesip"],
    "amkamec-3-6-ec": ["amkamec 3 6 ", "ec", "nong", "amkamec", "amkamec 3.6ec", "amkamec"],
    "atomin": ["atomin", "atomin"],
    "atomin-15wp": ["atomin 15wp", "atomin", "atomin15wp"],
    "azin-rio-45sc": ["azin rio 45", "sc", "mat", "azinrio", "azin", "rio"],
    ...
    "bilu": ["diet sau bilu"],
    "binhfos-50ec": ["diet sau binhfos 50", "ec", "nong", "binhfoc 500ec", "binhfos", "binfos", "bin fos"],
    "binhfos-50ec-vua-ray-rep": ["diet ray rep binhfos 50", "ec", "nong", "vua ray rep", "binhfos", "binfos", "bin fos"],
    ...
    "binhtox-3-8ec": ["diet sau binhtox 3 8", "ec", "nong", "binhtox", "binh tox", "bintox", "bin tox"],
    ...
    "biperin-100ec": ["diet sau biperin 100", "ec", "nong", "biperin"],
    "bipimai": ["diet sau bipimai", "bipimai", "bi pi"],
    "bipimai-150ec": ["diet sau bipimai 150", "ec", "nong", "bipimai", "bipimai 150ec", "bi pi"],
    ...
    "bpalatox-100ec": ["diet sau bpalatox 100", "ec", "nong", "bpalatox"],
    "bpsaco-500ec": ["diet sau bpsaco 500", "ec", "nong", "bpsaco"],
    "bretil-super-300ec": ["diet sau bretil super 300", "ec", "nong", "bretil"],
    "buti": ["diet sau buti", "buti"],
    "buti-43sc": ["diet sau buti 43", "sc", "mat", "buti"],
    ...
    "chlorfena-240sc": ["diet sau chlorfena 240", "sc", "mat", "chlorfena"],
    ...
    "cymkill-25ec": ["diet sau cymkill 25", "ec", "nong", "cymkill"],
    "daphamec-5-0ec": ["diet sau daphamec 5 0", "ec", "nong", "daphamec"],
    "daphamec-5ec": ["diet sau daphamec 5", "ec", "nong", "daphamec"],
    "diet-nhen-sam-set": ["diet nhen sam set", "diet nhen sam set", "diet nhen", "sam set"],
    "dolping-40ec": ["diet sau dolping 40", "ec", "nong", "dolping"],
    ...
    "dusan-240ec": ["dusan 240", "ec", "nong", "dusan", "dusan-240ec"],
    "ecudor-22-4sc": ["ecudor 22 4", "sc", "mat", "ecudor"],
    "emoil-99ec-spray": ["em oil 99", "ec", "nong", "Petrolium", "em oil", "em-oil", "oil", "emoil"],
    ...
    "forcin-50ec": ["forcin 50", "ec", "nong", "forcin"],
    "forgon-40ec": ["forgon 40", "ec", "nong", "forgon"],
    "forsan-60ec": ["forsan 60", "ec", "nong", "forsan"],
    "forsan-horisan": ["forsan horisan", "forsan horisan", "horisan", "forsan"],
    "fortac-5ec": ["fortac 5", "ec", "nong", "fortac"],
    ...
    "forzate-20ec": ["forzate 20", "ec", "nong", "forzate"],
    "forzate-20ew": ["forzate 20ew", "forzate"],
    "fuji-boss-30sc": ["fuji boss 30", "sc", "mat", "fujiboss", "fuji boss", "boss", "fuji", "2 hoat chat", "hai hoat chat"],
    "fujiboss-30sc": ["fuji boss 30", "sc", "mat", "fujiboss", "fuji boss", "boss", "fuji", "2 hoat chat", "hai hoat chat"],
    "fullkill-50ec": ["fullkill 50", "ec", "nong", "fullkill", "full kill", "full-kill", "kill"],
    "gangter-300ec": ["gangter 300", "ec", "nong", "gangter"],
    ...
    "gone-super-350ec": ["gone super 350", "ec", "nong", "gone super", "gone super 350ec", "gon super", "gone super",],
    "gorop-500ec": ["gorop 500", "ec", "nong", "gorop"],
    ...
    "haihamec-3-6e": ["haihamec 3 6e", "haihamec", "haihamec3.6", "ec", "nong", "haihamec3.6"],
    "haihamec-3-6ec": ["haihamec 3 6ec", "haihamec", "haihamec3.6", "ec", "nong", "haihamec3.6"],
    "hariwon-30sl": ["hariwon 30sl", "hariwon", "hariwon30sl", "hariwon-30sl"],
    "haruko-5sc": ["haruko 5", "sc", "mat", "tru sau haruko 5sc", "haruko", "haruko-5sc", "haruko5sc"],
    "hello-fungi-400": ["bao ve nam hello fungi 400", "diet nam hello fungi 400", "hello-fungi", "hello fungi", "hello", "fungi"],
    "hexa": ["hexa", "hexa", "hexa"],
    "hoanganhvil-50sc": ["hoang anh vil 50", "sc", "mat", "hoang anh vil 50sc", "hoanganhvil"],
    "hong-ha-nhi": ["hong ha nhi", "hong ha nhi", "hong ha nhi"],
    "hosu-10sc": ["ho su 10", "sc", "mat", "ho su 10sc", "hosu10sc", "hosu"],
    "ic-top-28-1sc": ["ic top 28 1", "sc", "mat", "ic top 28 1sc", "ictop", "ic-top", "ic top"],
    "ic-top-28-1sc-boocdor": ["ic top 28 1", "sc", "mat boocdor", "ic top 28 1sc boocdor", "ictop", "ic-top", "ic top"],
    "igro-240sc": ["igro 240", "sc", "mat", "igro 240sc", "igro", "igro240sc"],
    ...
    "igro-ohayo-240sc": ["igro ohayo 240", "sc", "mat", "igro ohayo 240sc", "igro", "igro240sc"],
    "igro-xpro": ["igro xpro", "igro xpro", "igro", "igro240", "sc", "mat"],
    "inmanda-100wp": ["inmanda 100wp", "inmanda 100wp", "inmanda", "inmanda", "inmanda"],
    "japasa-50ec": ["japasa 50", "ec", "nong", "japasa 50ec", "japasa"],
    ...
    "kajio-5ec": ["kajio 5", "ec", "nong", "kajio 5ec", "kajio", "kajio-5ec", "kajio5ec"],
    "kajio-5ec-g9-thanh-sau": ["kajio 5", "ec", "nong", "g9 thanh sau", "kajio 5ec g9 thanh sau", "kajio g9", "kajio-g9", "kajio 5ec", "kajio", "kajio-5ec", "kajio thanh sau"],
    ...
    "king-cide-japan-460sc": ["king cide japan 460", "sc", "mat", "king cide japan 460sc", "king cide japan 460sc", "king cide japan", "king cide", "kingcide", "king-cide", "3 hoat chat", "ba hoat chat"],
    "king-kha-1ec": ["king kha 1", "ec", "nong", "king kha 1ec", "king kha 1ec", "king kha", "kinh kha", "kingkha"],
    "koto-240sc": ["koto 240", "sc", "mat", "koto 240sc", "koto"],
    "koto-gold-240sc": ["koto gold 240", "sc", "mat", "koto gold 240sc", "koto", "koto-gold", "koto gold", "koto-gold"],
    "kyodo": ["kyodo", "kyodo", "kyodo"],
    "kyodo-25sc": ["kyodo 25", "sc", "mat", "kyodo 25sc", "kyodo"],
    ...
    "lama-50ec": ["lama 50", "ec", "nong", "lama 50ec", "lama"],
    "lao-ton-108ec": ["lao ton 108 ", "ec", "nong", "lao ton 108 ec", "lao ton"],
    "laoton-108ec": ["lao ton 108 ", "ec", "nong", "lao ton 108 ec", "lao ton"],
    ...
    "lekima-100ec": ["lekima 100 ", "ec", "nong", "lekima 100 ec", "lekima", "lekima"],
    "lufenuron-5ec": ["lufenuron 5 ", "ec", "nong", "diet sau lufenuron", "lufenuron 5 ec", "lufenuron"],
    "many-800wp": ["many 800 wp", "many 800 wp", "many"],
    "maruka-5ec": ["maruka 5 ", "ec", "nong", "maruka 5 ec", "maruka"],
    ...
    "mekongvil-5sc": ["mekongvil", "mekongvil 5 ", "sc", "mat", "mekongvil 5 sc"],
    "mi-stop-350sc": ["mistop", "mi-stop", "mi stop 350 ", "sc", "mat", "mi stop 350 sc"],
    "million-50wg": ["million", "million 50 wg", "million 50 wg"],
    "miriphos-1gb": ["miriphos", "miriphos 1 gb", "miriphos 1 gb"],
    "misung-15sc": ["misung", "misung 15 ", "sc", "mat", "misung 15 sc"],
    "mitop-one-390sc": ["mitop-one", "mitop one", "mitop", "mitop one 390", "sc", "mat", "3 hoat chat", "ba hoat chat"],
    "modusa-960ec": ["modusa", "modusa 960 ", "ec", "nong", "modusa 960 ec"],
    ...
    "nofara-350sc": ["nofara 350 ", "sc", "mat", "nofara 350 sc", "nofara"],
    ...
    "ohayo-100sc": ["ohayo 100 ", "sc", "mat", "ohayo 100 sc", "ohayo 100sc", "ohayo"],
    "ohayo-240sc": ["ohayo 240 ", "sc", "mat", "ohayo 240 sc", "ohayo 240sc", "ohayo"],
    ...
    "phonix-dragon-20ec": ["phonix dragon", "phonix dragon 20", "ec", "nong","phonix dragon", "phonix", "dragon"],
    ...
    "pyrolax-250ec": ["pyrolax", "pyrolax 250", "ec", "nong", "pyrolax"],
    "ram-te-thien": ["ram te", "ram te thien", "te thien"],
    "raynanusa-400wp": ["raynanusa", "raynanusa 400wp", "raynanusa"],
    "riceup-300ec": ["riceup", "riceup 300", "ec", "nong", "riceup"],
    "sam-san-2-5sc": ["sam san", "sam san 2 5", "sc", "mat", "sam san", "sam-san"],
    "sanbang-30sc": ["sanbang", "sanbang 30", "sc", "mat", "sanbang", "san bang", "sangbang", "sang bang"],
    "santoso-100sc": ["santoso", "santoso 100", "sc", "mat", "santoso"],
    "scorcarb-80wg": ["scorcarb", "scorcarb 80wg", "scorcarb"],
    "scortlan": ["scortlan", "scortlan"],
    "scortlan-80wp": ["scortlan 80wp", "scortlan"],
    "setis-34sc": ["setis", "setis 34", "sc", "mat", "setis"],
    "setis-giao-su-nhen-34sc": ["setis giao su nhen", "setis giao su nhen 34", "sc", "mat", "giao su nhen", "setis"],
    ...
    "shinawa-400ec": ["shinawa", "shinawa 400", "ec", "nong", "shinawa"],
    "shonam-500sc": ["shonam", "shonam 500", "sc", "mat", "shonam"],
    "showbiz": ["showbiz", "showbiz"],
    "showbiz-16sc": ["showbiz 16", "sc", "mat", "showbiz"],
    ...
    "somethrin-10ec": ["somethrin", "somethrin 10", "ec", "nong", "somethrin"],
    "su-tu-do": ["su tu do", "su tu do"],
    "suparep-22-4sc": ["suparep 22 4", "sc", "mat", "suparep", "suparep"],
    "suparep-400wp": ["suparep 400wp", "suparep"],
    "supermario-70sc": ["supermario 70", "sc", "mat", "supermario", "2 hoat chat", "hai hoat chat"],
    "suria-10gr": ["suria 10gr", "suria", "rai"],
    "suron-800wp": ["suron 800wp", "suron"],
    "takiwa-22sc": ["takiwa 22", "sc", "mat", "takiwa"],
    "tamatras": ["tamatras", "tamatras", "spirotetramat tolfenpyrad", "spirotetramat", "tolfenpyrad"],
    "tamiko-50ec": ["tamiko 50", "ec", "nong", "tamiko"],
    ...
    "tomi": ["tomi", "tomi"],
    "tomi-5ec": ["tomi 5", "ec", "nong", "tomi"],
    "topmesi-40sc": ["topmesi 40", "sc", "mat", "topmesi"],
    "topxapy-30sc": ["topxapy 30", "sc", "mat", "topxapy"],
    "topxim-pro-30sc": ["topxim pro 30", "sc", "mat", "topxim", "topximpro"],
    "toshiro-10ec": ["toshiro 10", "ec", "nong", "toshiro"],
    "tosi": ["tosi", "tosi"],
    "tosi-30wg": ["tosi 30wg", "tosi"],
    ...
    "uchong-40ec": ["uchong 40", "ec", "nong", "uchong"],
    ...
    "voi-thai-3-6ec-gold": ["voi thai 3 6", "ec", "nong", "gold", "voi thai"],
    ...
    "zigen": ["zigen", "zigen"],
    "zigen-15sc": ["zigen 15", "sc", "mat", "zigen"],
    "zigen-super": ["zigen super", "zigen"],
    "zigen-super-15sc": ["zigen super 15", "sc", "mat", "zigen"],
